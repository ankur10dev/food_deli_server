...
const stripePromise = loadStripe(
  "pk_test_51PWtjlSB7uBVZOVtMDCmdWCzfulRuiSDkXxoRc5o53exuTI8ZQ29nnUfzaRlYaTAybJb5I4biQl2hOMAWzHr0ZyT00F7jkjOq3"
);
    ...
    <div className="p-4 mt-16 max-w-[1400px] mx-auto">
      ...
      <div className="text-center mt-8">
        ...
        <button
          ...
          className="text-white text-xl font-bold py-4 px-8 rounded-xl bg-gradient-to-r from-green-600
